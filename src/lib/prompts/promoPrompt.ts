...
쉼표(,) 제한적 허용: 호흡에 필요한 곳만 쓰세요(한 문장 1~2개 이내, 남발 금지). 연결 어미('~해서' '~하니까' '~는데')로도 자연스럽게 이으세요.
이모지 금지 / 느낌표는 거의 쓰지 마세요.
번호목록 금지: 본문에 "1. 2. 3." "①②③" 같은 번호 나열이나 불릿 목록을 쓰지 말고 문장으로 풀어 쓰세요.
...
────────────────────────────────────
[아래 출력 구조는 '뼈대 안내'일 뿐입니다 — 절대 규칙]
※ 대괄호 머리글([행사 핵심 요약]·[혜택 소개] 등)과 괄호 설명문, "(지도 정보가 들어갈 자리)" "[확인 필요]" 같은 자리표시자를 출력에 그대로 쓰지 마세요. 실제 문장과 실제 정보로만 채우고, 없는 정보는 그 줄을 생략하세요.
────────────────────────────────────
${outputFormat}
────────────────────────────────────
